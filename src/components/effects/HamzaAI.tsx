...
const RESPONSES: [string[], string][] = [
  ...
  [['project','app','built','work','portfolio','ship'],
    "He's shipped: ToolBox Master (dev utility suite), DayPilot (AI planner), LockBox Pro (encrypted vault), and more in development. Want me to tell you about a specific project? 📱"],
  [['contact','hire','work together','collab','price','rate','cost','budget'],
    "Hamza is available for app projects, AI integrations, and creative collaborations. Best way to reach him: scroll down to the Contact section and fire a message. He responds fast. ⚡"],
  [['pakistan','from','where','location','country'],
    "Born and building in Pakistan 🇵🇰 — available for remote projects worldwide. Different timezone, same dedication. He's been known to ship features while half the world is sleeping. 🌍"],
